class tablaAsistencias extends HTMLElement{
                        ...
                        <div class="card-body p-0">
                          <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 100%">
                            <table class="table table-striped mb-0">
                              ...
                              <tbody>`
            this.jugadores.sort((a,b) => b.asistencias - a.asistencias)
    ...
    window.customElements.define("tabla-asistencias", tablaAsistencias);
    const iniciarTablaAsistencias = new tablaAsistencias();
